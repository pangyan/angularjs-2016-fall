...
#   }
   ...
   unless ($f_month eq 'XX') {
      if ($real_month eq '1') {
         print "<font size=6><b> $real_month Month </font></b>";
      } else {
         print "<font size=6><b> $real_month Months </font></b>";
      }
   }

   unless ($f_day eq 'XX') {
      if ($real_day eq '1') {
         print "<font size=6><b> $real_day Day  </b></font><br> \n";
      } else {
         print "<font size=6><b> $real_day Days  </b></font><br> \n";
      }
   }
...
sub html_header {
   ...
   print "<body><center><h1>Days To Go for Job Training</h1>\n";
   print "<hr>\n";
}
